describe('angularjs lista de tarefas', function() {
  it('deve validar a quantidade de itens da lista', function() {
    browser.get('http://localhost:3000/');

    var listaTarefa = element.all(by.repeater('item in vm.listaTarefa'));
  ...
  it('deve adicionar um item na lista', function() {
    var itemDescricao = element(by.model('vm.itemDescricao')),
        listaTarefa = element.all(by.repeater('item in vm.listaTarefa'));
